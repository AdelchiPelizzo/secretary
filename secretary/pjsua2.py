...
class ByteVector(object):
    ...
    def assign_from_bytes(self, obj):
        return _pjsua2.ByteVector_assign_from_bytes(self, obj)

    def copy_to_bytearray(self, obj):
        return _pjsua2.ByteVector_copy_to_bytearray(self, obj)
...
PJ_O_ASYNC = _pjsua2.PJ_O_ASYNC
PJ_O_SEQUENTIAL = _pjsua2.PJ_O_SEQUENTIAL
PJ_O_RANDOM = _pjsua2.PJ_O_RANDOM
...
PJ_TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384 = _pjsua2.PJ_TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384
PJ_TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 = _pjsua2.PJ_TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384
PJ_TLS_DHE_DSS_WITH_AES_256_GCM_SHA384 = _pjsua2.PJ_TLS_DHE_DSS_WITH_AES_256_GCM_SHA384
PJ_TLS_DHE_RSA_WITH_AES_256_GCM_SHA384 = _pjsua2.PJ_TLS_DHE_RSA_WITH_AES_256_GCM_SHA384
PJ_TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256 = _pjsua2.PJ_TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256
PJ_TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256 = _pjsua2.PJ_TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256
PJ_TLS_AES_128_GCM_SHA256 = _pjsua2.PJ_TLS_AES_128_GCM_SHA256
PJ_TLS_AES_256_GCM_SHA384 = _pjsua2.PJ_TLS_AES_256_GCM_SHA384
PJ_TLS_CHACHA20_POLY1305_SHA256 = _pjsua2.PJ_TLS_CHACHA20_POLY1305_SHA256
...
PJ_SSL_CERT_DIRECT_NONE = _pjsua2.PJ_SSL_CERT_DIRECT_NONE
PJ_SSL_CERT_DIRECT_OPENSSL_EVP_PKEY = _pjsua2.PJ_SSL_CERT_DIRECT_OPENSSL_EVP_PKEY
PJ_SSL_CERT_DIRECT_OPENSSL_X509_CERT = _pjsua2.PJ_SSL_CERT_DIRECT_OPENSSL_X509_CERT
...
PJMEDIA_CONF_OP_UNKNOWN = _pjsua2.PJMEDIA_CONF_OP_UNKNOWN
PJMEDIA_CONF_OP_ADD_PORT = _pjsua2.PJMEDIA_CONF_OP_ADD_PORT
PJMEDIA_CONF_OP_REMOVE_PORT = _pjsua2.PJMEDIA_CONF_OP_REMOVE_PORT
PJMEDIA_CONF_OP_CONNECT_PORTS = _pjsua2.PJMEDIA_CONF_OP_CONNECT_PORTS
PJMEDIA_CONF_OP_DISCONNECT_PORTS = _pjsua2.PJMEDIA_CONF_OP_DISCONNECT_PORTS
PJMEDIA_CONF_OP_ADJUST_CONN_LEVEL = _pjsua2.PJMEDIA_CONF_OP_ADJUST_CONN_LEVEL
...
PJMEDIA_FORMAT_G722 = _pjsua2.PJMEDIA_FORMAT_G722
...
PJMEDIA_JB_DISCARD_NONE = _pjsua2.PJMEDIA_JB_DISCARD_NONE
PJMEDIA_JB_DISCARD_STATIC = _pjsua2.PJMEDIA_JB_DISCARD_STATIC
PJMEDIA_JB_DISCARD_PROGRESSIVE = _pjsua2.PJMEDIA_JB_DISCARD_PROGRESSIVE
...
PJMEDIA_TYPE_TEXT = _pjsua2.PJMEDIA_TYPE_TEXT
...
PJMEDIA_VID_DEV_HWND_TYPE_NONE = _pjsua2.PJMEDIA_VID_DEV_HWND_TYPE_NONE
PJMEDIA_VID_DEV_HWND_TYPE_WINDOWS = _pjsua2.PJMEDIA_VID_DEV_HWND_TYPE_WINDOWS
PJMEDIA_VID_DEV_HWND_TYPE_COCOA = _pjsua2.PJMEDIA_VID_DEV_HWND_TYPE_COCOA
PJMEDIA_VID_DEV_HWND_TYPE_IOS = _pjsua2.PJMEDIA_VID_DEV_HWND_TYPE_IOS
PJMEDIA_VID_DEV_HWND_TYPE_ANDROID = _pjsua2.PJMEDIA_VID_DEV_HWND_TYPE_ANDROID
...
PJMEDIA_VID_CONF_OP_UNKNOWN = _pjsua2.PJMEDIA_VID_CONF_OP_UNKNOWN
PJMEDIA_VID_CONF_OP_ADD_PORT = _pjsua2.PJMEDIA_VID_CONF_OP_ADD_PORT
PJMEDIA_VID_CONF_OP_REMOVE_PORT = _pjsua2.PJMEDIA_VID_CONF_OP_REMOVE_PORT
PJMEDIA_VID_CONF_OP_CONNECT_PORTS = _pjsua2.PJMEDIA_VID_CONF_OP_CONNECT_PORTS
PJMEDIA_VID_CONF_OP_DISCONNECT_PORTS = _pjsua2.PJMEDIA_VID_CONF_OP_DISCONNECT_PORTS
PJMEDIA_VID_CONF_OP_UPDATE_PORT = _pjsua2.PJMEDIA_VID_CONF_OP_UPDATE_PORT
...
PJMEDIA_VID_STREAM_RC_SEND_THREAD = _pjsua2.PJMEDIA_VID_STREAM_RC_SEND_THREAD
PJMEDIA_AI_EVENT_CONNECTED = _pjsua2.PJMEDIA_AI_EVENT_CONNECTED
PJMEDIA_AI_EVENT_DISCONNECTED = _pjsua2.PJMEDIA_AI_EVENT_DISCONNECTED
PJMEDIA_AI_EVENT_TRANSCRIPT = _pjsua2.PJMEDIA_AI_EVENT_TRANSCRIPT
PJMEDIA_AI_EVENT_RESPONSE_START = _pjsua2.PJMEDIA_AI_EVENT_RESPONSE_START
PJMEDIA_AI_EVENT_RESPONSE_DONE = _pjsua2.PJMEDIA_AI_EVENT_RESPONSE_DONE
PJMEDIA_AI_EVENT_SPEECH_STARTED = _pjsua2.PJMEDIA_AI_EVENT_SPEECH_STARTED
PJMEDIA_AI_EVENT_SPEECH_STOPPED = _pjsua2.PJMEDIA_AI_EVENT_SPEECH_STOPPED
...
PJMEDIA_FILE_NO_LOCK = _pjsua2.PJMEDIA_FILE_NO_LOCK
...
PJSUA_CALL_NO_MEDIA_SYNC = _pjsua2.PJSUA_CALL_NO_MEDIA_SYNC
...
PJSUA_SIP_SIPREC_INACTIVE = _pjsua2.PJSUA_SIP_SIPREC_INACTIVE
PJSUA_SIP_SIPREC_OPTIONAL = _pjsua2.PJSUA_SIP_SIPREC_OPTIONAL
PJSUA_SIP_SIPREC_MANDATORY = _pjsua2.PJSUA_SIP_SIPREC_MANDATORY
...
class AuthCredInfo(PersistentObject):
    ...
    algoType = property(_pjsua2.AuthCredInfo_algoType_get, _pjsua2.AuthCredInfo_algoType_set)
...
class SockOpt(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    level = property(_pjsua2.SockOpt_level_get, _pjsua2.SockOpt_level_set)
    optName = property(_pjsua2.SockOpt_optName_get, _pjsua2.SockOpt_optName_set)
...
class SockOptParams(PersistentObject):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    sockOpts = property(_pjsua2.SockOptParams_sockOpts_get, _pjsua2.SockOptParams_sockOpts_set)
...
class TlsConfig(PersistentObject):
    ...
    certLookupType = property(_pjsua2.TlsConfig_certLookupType_get, _pjsua2.TlsConfig_certLookupType_set)
    certLookupKeyword = property(_pjsua2.TlsConfig_certLookupKeyword_get, _pjsua2.TlsConfig_certLookupKeyword_set)
    credDirectType = property(_pjsua2.TlsConfig_credDirectType_get, _pjsua2.TlsConfig_credDirectType_set)
    privKeyDirect = property(_pjsua2.TlsConfig_privKeyDirect_get, _pjsua2.TlsConfig_privKeyDirect_set)
    certDirect = property(_pjsua2.TlsConfig_certDirect_get, _pjsua2.TlsConfig_certDirect_set)
    ...
    sockOptParams = property(_pjsua2.TlsConfig_sockOptParams_get, _pjsua2.TlsConfig_sockOptParams_set)
    sockOptIgnoreError = property(_pjsua2.TlsConfig_sockOptIgnoreError_get, _pjsua2.TlsConfig_sockOptIgnoreError_set)
...
class TransportConfig(PersistentObject):
    ...
    sockOptParams = property(_pjsua2.TransportConfig_sockOptParams_get, _pjsua2.TransportConfig_sockOptParams_set)
...
class SipTxOption(object):
    ...
    contactUri = property(_pjsua2.SipTxOption_contactUri_get, _pjsua2.SipTxOption_contactUri_set)
...
class AiMediaEvent(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    type = property(_pjsua2.AiMediaEvent_type_get, _pjsua2.AiMediaEvent_type_set)
    status = property(_pjsua2.AiMediaEvent_status_get, _pjsua2.AiMediaEvent_status_set)
    text = property(_pjsua2.AiMediaEvent_text_get, _pjsua2.AiMediaEvent_text_set)

    def __init__(self):
        _pjsua2.AiMediaEvent_swiginit(self, _pjsua2.new_AiMediaEvent())
    __swig_destroy__ = _pjsua2.delete_AiMediaEvent

# Register AiMediaEvent in _pjsua2:
_pjsua2.AiMediaEvent_swigregister(AiMediaEvent)
class AiMediaPortParam(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    vadEnabled = property(_pjsua2.AiMediaPortParam_vadEnabled_get, _pjsua2.AiMediaPortParam_vadEnabled_set)
    ptimeMsec = property(_pjsua2.AiMediaPortParam_ptimeMsec_get, _pjsua2.AiMediaPortParam_ptimeMsec_set)

    def __init__(self):
        _pjsua2.AiMediaPortParam_swiginit(self, _pjsua2.new_AiMediaPortParam())
    __swig_destroy__ = _pjsua2.delete_AiMediaPortParam

# Register AiMediaPortParam in _pjsua2:
_pjsua2.AiMediaPortParam_swigregister(AiMediaPortParam)
class AudioMediaAiPort(AudioMedia):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self):
        if self.__class__ == AudioMediaAiPort:
            _self = None
        else:
            _self = self
        _pjsua2.AudioMediaAiPort_swiginit(self, _pjsua2.new_AudioMediaAiPort(_self, ))
    __swig_destroy__ = _pjsua2.delete_AudioMediaAiPort

    def createPort(self, *args):
        return _pjsua2.AudioMediaAiPort_createPort(self, *args)

    def connect(self, url, authToken):
        return _pjsua2.AudioMediaAiPort_connect(self, url, authToken)

    def disconnect(self):
        return _pjsua2.AudioMediaAiPort_disconnect(self)

    def onEvent(self, event):
        return _pjsua2.AudioMediaAiPort_onEvent(self, event)
    def __disown__(self):
        self.this.disown()
        _pjsua2.disown_AudioMediaAiPort(self)
        return weakref.proxy(self)

# Register AudioMediaAiPort in _pjsua2:
_pjsua2.AudioMediaAiPort_swigregister(AudioMediaAiPort)
...
class VideoPlayer(object):
    ...
    def __init__(self):
        _pjsua2.VideoPlayer_swiginit(self, _pjsua2.new_VideoPlayer())

    def createVideoPlayer(self, file_name):
        return _pjsua2.VideoPlayer_createVideoPlayer(self, file_name)

    def mediaEnumPorts(self):
        return _pjsua2.VideoPlayer_mediaEnumPorts(self)

    def mediaEnumVidPorts(self):
        return _pjsua2.VideoPlayer_mediaEnumVidPorts(self)

    def getVideoDevId(self):
        return _pjsua2.VideoPlayer_getVideoDevId(self)
    __swig_destroy__ = _pjsua2.delete_VideoPlayer

# Register VideoPlayer in _pjsua2:
_pjsua2.VideoPlayer_swigregister(VideoPlayer)
class VideoRecorder(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self):
        if self.__class__ == VideoRecorder:
            _self = None
        else:
            _self = self
        _pjsua2.VideoRecorder_swiginit(self, _pjsua2.new_VideoRecorder(_self, ))

    def createVideoRecorder(self, file_name, max_size=0, vid_fmt=None, aud_fmt=None, options=0):
        return _pjsua2.VideoRecorder_createVideoRecorder(self, file_name, max_size, vid_fmt, aud_fmt, options)

    def getVideoMedia(self):
        return _pjsua2.VideoRecorder_getVideoMedia(self)

    def getAudioMedia(self):
        return _pjsua2.VideoRecorder_getAudioMedia(self)

    def onMaxSize(self):
        return _pjsua2.VideoRecorder_onMaxSize(self)
    __swig_destroy__ = _pjsua2.delete_VideoRecorder
    def __disown__(self):
        self.this.disown()
        _pjsua2.disown_VideoRecorder(self)
        return weakref.proxy(self)

# Register VideoRecorder in _pjsua2:
_pjsua2.VideoRecorder_swigregister(VideoRecorder)
...
class CodecLyraConfig(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    bitRate = property(_pjsua2.CodecLyraConfig_bitRate_get, _pjsua2.CodecLyraConfig_bitRate_set)
    modelPath = property(_pjsua2.CodecLyraConfig_modelPath_get, _pjsua2.CodecLyraConfig_modelPath_set)
...
class BuddyConfig(PersistentObject):
    ...
    subscribe_dlg_event = property(_pjsua2.BuddyConfig_subscribe_dlg_event_get, _pjsua2.BuddyConfig_subscribe_dlg_event_set)
...
class BuddyInfo(object):
    ...
    accId = property(_pjsua2.BuddyInfo_accId_get, _pjsua2.BuddyInfo_accId_set)
...
class Buddy(object):
    ...
    def subscribeDlgEvent(self, subscribe):
        return _pjsua2.Buddy_subscribeDlgEvent(self, subscribe)

    def updateDlgEvent(self):
        return _pjsua2.Buddy_updateDlgEvent(self)
...
class AccountRegConfig(PersistentObject):
    ...
    disableRegOnModify = property(_pjsua2.AccountRegConfig_disableRegOnModify_get, _pjsua2.AccountRegConfig_disableRegOnModify_set)
...
class AccountSipConfig(PersistentObject):
    ...
    useSharedAuth = property(_pjsua2.AccountSipConfig_useSharedAuth_get, _pjsua2.AccountSipConfig_useSharedAuth_set)
    autoRespondSipMessage = property(_pjsua2.AccountSipConfig_autoRespondSipMessage_get, _pjsua2.AccountSipConfig_autoRespondSipMessage_set)
...
class AccountCallConfig(PersistentObject):
    ...
    siprecUse = property(_pjsua2.AccountCallConfig_siprecUse_get, _pjsua2.AccountCallConfig_siprecUse_set)
...
class AccountNatConfig(PersistentObject):
    ...
    iceManualHost = property(_pjsua2.AccountNatConfig_iceManualHost_get, _pjsua2.AccountNatConfig_iceManualHost_set)
    ...
    iceCheckSrcAddr = property(_pjsua2.AccountNatConfig_iceCheckSrcAddr_get, _pjsua2.AccountNatConfig_iceCheckSrcAddr_set)
...
class SendRequestParam(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    userData = property(_pjsua2.SendRequestParam_userData_get, _pjsua2.SendRequestParam_userData_set)
    method = property(_pjsua2.SendRequestParam_method_get, _pjsua2.SendRequestParam_method_set)
    txOption = property(_pjsua2.SendRequestParam_txOption_get, _pjsua2.SendRequestParam_txOption_set)
...
class AccountTextConfig(PersistentObject):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    redundancyLevel = property(_pjsua2.AccountTextConfig_redundancyLevel_get, _pjsua2.AccountTextConfig_redundancyLevel_set)

    def __init__(self):
        _pjsua2.AccountTextConfig_swiginit(self, _pjsua2.new_AccountTextConfig())

    def readObject(self, node):
        return _pjsua2.AccountTextConfig_readObject(self, node)

    def writeObject(self, node):
        return _pjsua2.AccountTextConfig_writeObject(self, node)
    __swig_destroy__ = _pjsua2.delete_AccountTextConfig

# Register AccountTextConfig in _pjsua2:
_pjsua2.AccountTextConfig_swigregister(AccountTextConfig)
...
class AccountConfig(PersistentObject):
    ...
    textConfig = property(_pjsua2.AccountConfig_textConfig_get, _pjsua2.AccountConfig_textConfig_set)
...
class OnSendRequestParam(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    userData = property(_pjsua2.OnSendRequestParam_userData_get, _pjsua2.OnSendRequestParam_userData_set)
    e = property(_pjsua2.OnSendRequestParam_e_get, _pjsua2.OnSendRequestParam_e_set)
...
class AuthChallenge(object):
    ...
    def __init__(self):
        _pjsua2.AuthChallenge_swiginit(self, _pjsua2.new_AuthChallenge())
    __swig_destroy__ = _pjsua2.delete_AuthChallenge

    def defer(self):
        return _pjsua2.AuthChallenge_defer(self)

    def respond(self, *args):
        return _pjsua2.AuthChallenge_respond(self, *args)

    def abandon(self):
        return _pjsua2.AuthChallenge_abandon(self)

    def isValid(self):
        return _pjsua2.AuthChallenge_isValid(self)

# Register AuthChallenge in _pjsua2:
_pjsua2.AuthChallenge_swigregister(AuthChallenge)
class OnAuthChallengeParam(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    accId = property(_pjsua2.OnAuthChallengeParam_accId_get, _pjsua2.OnAuthChallengeParam_accId_set)
    callId = property(_pjsua2.OnAuthChallengeParam_callId_get, _pjsua2.OnAuthChallengeParam_callId_set)
    rdata = property(_pjsua2.OnAuthChallengeParam_rdata_get, _pjsua2.OnAuthChallengeParam_rdata_set)
    challenge = property(_pjsua2.OnAuthChallengeParam_challenge_get)

    def __init__(self):
        _pjsua2.OnAuthChallengeParam_swiginit(self, _pjsua2.new_OnAuthChallengeParam())
    __swig_destroy__ = _pjsua2.delete_OnAuthChallengeParam

# Register OnAuthChallengeParam in _pjsua2:
_pjsua2.OnAuthChallengeParam_swigregister(OnAuthChallengeParam)
...
class DeferredResponse(object):
    ...
    def __init__(self, *args):
        _pjsua2.DeferredResponse_swiginit(self, _pjsua2.new_DeferredResponse(*args))
    __swig_destroy__ = _pjsua2.delete_DeferredResponse

# Register DeferredResponse in _pjsua2:
_pjsua2.DeferredResponse_swigregister(DeferredResponse)
class SendResponseParam(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    deferredResponse = property(_pjsua2.SendResponseParam_deferredResponse_get, _pjsua2.SendResponseParam_deferredResponse_set)
    code = property(_pjsua2.SendResponseParam_code_get, _pjsua2.SendResponseParam_code_set)
    reason = property(_pjsua2.SendResponseParam_reason_get, _pjsua2.SendResponseParam_reason_set)

    def __init__(self):
        _pjsua2.SendResponseParam_swiginit(self, _pjsua2.new_SendResponseParam())
    __swig_destroy__ = _pjsua2.delete_SendResponseParam

# Register SendResponseParam in _pjsua2:
_pjsua2.SendResponseParam_swigregister(SendResponseParam)
class AccountShutdownParam(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    force = property(_pjsua2.AccountShutdownParam_force_get, _pjsua2.AccountShutdownParam_force_set)

    def __init__(self):
        _pjsua2.AccountShutdownParam_swiginit(self, _pjsua2.new_AccountShutdownParam())
    __swig_destroy__ = _pjsua2.delete_AccountShutdownParam

# Register AccountShutdownParam in _pjsua2:
_pjsua2.AccountShutdownParam_swigregister(AccountShutdownParam)
class Account(object):
    ...
    def shutdown2(self, prm):
        return _pjsua2.Account_shutdown2(self, prm)
    ...
    def sendResponse(self, prm):
        return _pjsua2.Account_sendResponse(self, prm)
    ...
    def onAuthChallenge(self, prm):
        return _pjsua2.Account_onAuthChallenge(self, prm)
    def __disown__(self):
        self.this.disown()
...
class CallSetting(object):
    ...
    textCount = property(_pjsua2.CallSetting_textCount_get, _pjsua2.CallSetting_textCount_set)
    mediaDir = property(_pjsua2.CallSetting_mediaDir_get, _pjsua2.CallSetting_mediaDir_set)
    customCallId = property(_pjsua2.CallSetting_customCallId_get, _pjsua2.CallSetting_customCallId_set)
...
class CallInfo(object):
    ...
    remTextCount = property(_pjsua2.CallInfo_remTextCount_get, _pjsua2.CallInfo_remTextCount_set)
...
class OnCallRxTextParam(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    seq = property(_pjsua2.OnCallRxTextParam_seq_get, _pjsua2.OnCallRxTextParam_seq_set)
    ts = property(_pjsua2.OnCallRxTextParam_ts_get, _pjsua2.OnCallRxTextParam_ts_set)
    text = property(_pjsua2.OnCallRxTextParam_text_get, _pjsua2.OnCallRxTextParam_text_set)

    def __init__(self):
        _pjsua2.OnCallRxTextParam_swiginit(self, _pjsua2.new_OnCallRxTextParam())
    __swig_destroy__ = _pjsua2.delete_OnCallRxTextParam

# Register OnCallRxTextParam in _pjsua2:
_pjsua2.OnCallRxTextParam_swigregister(OnCallRxTextParam)
...
class OnCallMediaEventParam(object):
    ...
    def __init__(self, *args):
        _pjsua2.OnCallMediaEventParam_swiginit(self, _pjsua2.new_OnCallMediaEventParam(*args))
...
class CallSendTextParam(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    medIdx = property(_pjsua2.CallSendTextParam_medIdx_get, _pjsua2.CallSendTextParam_medIdx_set)
    text = property(_pjsua2.CallSendTextParam_text_get, _pjsua2.CallSendTextParam_text_set)

    def __init__(self):
        _pjsua2.CallSendTextParam_swiginit(self, _pjsua2.new_CallSendTextParam())
    __swig_destroy__ = _pjsua2.delete_CallSendTextParam

# Register CallSendTextParam in _pjsua2:
_pjsua2.CallSendTextParam_swigregister(CallSendTextParam)
class Call(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    ...
    def sendText(self, param):
        return _pjsua2.Call_sendText(self, param)
    ...
    def onCallRxText(self, prm):
        return _pjsua2.Call_onCallRxText(self, prm)
...
class IpChangeParam(object):
    ...
    shutdownTransport = property(_pjsua2.IpChangeParam_shutdownTransport_get, _pjsua2.IpChangeParam_shutdownTransport_set)
...
class AudioMediaAddInfo(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    mediaId = property(_pjsua2.AudioMediaAddInfo_mediaId_get, _pjsua2.AudioMediaAddInfo_mediaId_set)

    def __init__(self):
        _pjsua2.AudioMediaAddInfo_swiginit(self, _pjsua2.new_AudioMediaAddInfo())
    __swig_destroy__ = _pjsua2.delete_AudioMediaAddInfo

# Register AudioMediaAddInfo in _pjsua2:
_pjsua2.AudioMediaAddInfo_swigregister(AudioMediaAddInfo)
class AudioMediaRemoveInfo(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    mediaId = property(_pjsua2.AudioMediaRemoveInfo_mediaId_get, _pjsua2.AudioMediaRemoveInfo_mediaId_set)

    def __init__(self):
        _pjsua2.AudioMediaRemoveInfo_swiginit(self, _pjsua2.new_AudioMediaRemoveInfo())
    __swig_destroy__ = _pjsua2.delete_AudioMediaRemoveInfo

# Register AudioMediaRemoveInfo in _pjsua2:
_pjsua2.AudioMediaRemoveInfo_swigregister(AudioMediaRemoveInfo)
class AudioMediaConnectInfo(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    mediaId = property(_pjsua2.AudioMediaConnectInfo_mediaId_get, _pjsua2.AudioMediaConnectInfo_mediaId_set)
    targetMediaId = property(_pjsua2.AudioMediaConnectInfo_targetMediaId_get, _pjsua2.AudioMediaConnectInfo_targetMediaId_set)
    adjLevel = property(_pjsua2.AudioMediaConnectInfo_adjLevel_get, _pjsua2.AudioMediaConnectInfo_adjLevel_set)

    def __init__(self):
        _pjsua2.AudioMediaConnectInfo_swiginit(self, _pjsua2.new_AudioMediaConnectInfo())
    __swig_destroy__ = _pjsua2.delete_AudioMediaConnectInfo

# Register AudioMediaConnectInfo in _pjsua2:
_pjsua2.AudioMediaConnectInfo_swigregister(AudioMediaConnectInfo)
class AudioMediaDisconnectInfo(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    mediaId = property(_pjsua2.AudioMediaDisconnectInfo_mediaId_get, _pjsua2.AudioMediaDisconnectInfo_mediaId_set)
    targetMediaId = property(_pjsua2.AudioMediaDisconnectInfo_targetMediaId_get, _pjsua2.AudioMediaDisconnectInfo_targetMediaId_set)

    def __init__(self):
        _pjsua2.AudioMediaDisconnectInfo_swiginit(self, _pjsua2.new_AudioMediaDisconnectInfo())
    __swig_destroy__ = _pjsua2.delete_AudioMediaDisconnectInfo

# Register AudioMediaDisconnectInfo in _pjsua2:
_pjsua2.AudioMediaDisconnectInfo_swigregister(AudioMediaDisconnectInfo)
class AudioMediaOpParam(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    addInfo = property(_pjsua2.AudioMediaOpParam_addInfo_get, _pjsua2.AudioMediaOpParam_addInfo_set)
    removeInfo = property(_pjsua2.AudioMediaOpParam_removeInfo_get, _pjsua2.AudioMediaOpParam_removeInfo_set)
    connectInfo = property(_pjsua2.AudioMediaOpParam_connectInfo_get, _pjsua2.AudioMediaOpParam_connectInfo_set)
    disconnectInfo = property(_pjsua2.AudioMediaOpParam_disconnectInfo_get, _pjsua2.AudioMediaOpParam_disconnectInfo_set)

    def __init__(self):
        _pjsua2.AudioMediaOpParam_swiginit(self, _pjsua2.new_AudioMediaOpParam())
    __swig_destroy__ = _pjsua2.delete_AudioMediaOpParam

# Register AudioMediaOpParam in _pjsua2:
_pjsua2.AudioMediaOpParam_swigregister(AudioMediaOpParam)
class OnAudioMediaOpCompletedParam(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    opType = property(_pjsua2.OnAudioMediaOpCompletedParam_opType_get, _pjsua2.OnAudioMediaOpCompletedParam_opType_set)
    status = property(_pjsua2.OnAudioMediaOpCompletedParam_status_get, _pjsua2.OnAudioMediaOpCompletedParam_status_set)
    opParam = property(_pjsua2.OnAudioMediaOpCompletedParam_opParam_get, _pjsua2.OnAudioMediaOpCompletedParam_opParam_set)

    def __init__(self):
        _pjsua2.OnAudioMediaOpCompletedParam_swiginit(self, _pjsua2.new_OnAudioMediaOpCompletedParam())
    __swig_destroy__ = _pjsua2.delete_OnAudioMediaOpCompletedParam

# Register OnAudioMediaOpCompletedParam in _pjsua2:
_pjsua2.OnAudioMediaOpCompletedParam_swigregister(OnAudioMediaOpCompletedParam)
class VideoMediaAddInfo(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    mediaId = property(_pjsua2.VideoMediaAddInfo_mediaId_get, _pjsua2.VideoMediaAddInfo_mediaId_set)

    def __init__(self):
        _pjsua2.VideoMediaAddInfo_swiginit(self, _pjsua2.new_VideoMediaAddInfo())
    __swig_destroy__ = _pjsua2.delete_VideoMediaAddInfo

# Register VideoMediaAddInfo in _pjsua2:
_pjsua2.VideoMediaAddInfo_swigregister(VideoMediaAddInfo)
class VideoMediaRemoveInfo(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    mediaId = property(_pjsua2.VideoMediaRemoveInfo_mediaId_get, _pjsua2.VideoMediaRemoveInfo_mediaId_set)

    def __init__(self):
        _pjsua2.VideoMediaRemoveInfo_swiginit(self, _pjsua2.new_VideoMediaRemoveInfo())
    __swig_destroy__ = _pjsua2.delete_VideoMediaRemoveInfo

# Register VideoMediaRemoveInfo in _pjsua2:
_pjsua2.VideoMediaRemoveInfo_swigregister(VideoMediaRemoveInfo)
class VideoMediaConnectInfo(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    mediaId = property(_pjsua2.VideoMediaConnectInfo_mediaId_get, _pjsua2.VideoMediaConnectInfo_mediaId_set)
    targetMediaId = property(_pjsua2.VideoMediaConnectInfo_targetMediaId_get, _pjsua2.VideoMediaConnectInfo_targetMediaId_set)

    def __init__(self):
        _pjsua2.VideoMediaConnectInfo_swiginit(self, _pjsua2.new_VideoMediaConnectInfo())
    __swig_destroy__ = _pjsua2.delete_VideoMediaConnectInfo

# Register VideoMediaConnectInfo in _pjsua2:
_pjsua2.VideoMediaConnectInfo_swigregister(VideoMediaConnectInfo)
class VideoMediaDisconnectInfo(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    mediaId = property(_pjsua2.VideoMediaDisconnectInfo_mediaId_get, _pjsua2.VideoMediaDisconnectInfo_mediaId_set)
    targetMediaId = property(_pjsua2.VideoMediaDisconnectInfo_targetMediaId_get, _pjsua2.VideoMediaDisconnectInfo_targetMediaId_set)

    def __init__(self):
        _pjsua2.VideoMediaDisconnectInfo_swiginit(self, _pjsua2.new_VideoMediaDisconnectInfo())
    __swig_destroy__ = _pjsua2.delete_VideoMediaDisconnectInfo

# Register VideoMediaDisconnectInfo in _pjsua2:
_pjsua2.VideoMediaDisconnectInfo_swigregister(VideoMediaDisconnectInfo)
class VideoMediaUpdateInfo(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    mediaId = property(_pjsua2.VideoMediaUpdateInfo_mediaId_get, _pjsua2.VideoMediaUpdateInfo_mediaId_set)

    def __init__(self):
        _pjsua2.VideoMediaUpdateInfo_swiginit(self, _pjsua2.new_VideoMediaUpdateInfo())
    __swig_destroy__ = _pjsua2.delete_VideoMediaUpdateInfo

# Register VideoMediaUpdateInfo in _pjsua2:
_pjsua2.VideoMediaUpdateInfo_swigregister(VideoMediaUpdateInfo)
class VideoMediaOpParam(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    addInfo = property(_pjsua2.VideoMediaOpParam_addInfo_get, _pjsua2.VideoMediaOpParam_addInfo_set)
    removeInfo = property(_pjsua2.VideoMediaOpParam_removeInfo_get, _pjsua2.VideoMediaOpParam_removeInfo_set)
    connectInfo = property(_pjsua2.VideoMediaOpParam_connectInfo_get, _pjsua2.VideoMediaOpParam_connectInfo_set)
    disconnectInfo = property(_pjsua2.VideoMediaOpParam_disconnectInfo_get, _pjsua2.VideoMediaOpParam_disconnectInfo_set)
    updateInfo = property(_pjsua2.VideoMediaOpParam_updateInfo_get, _pjsua2.VideoMediaOpParam_updateInfo_set)

    def __init__(self):
        _pjsua2.VideoMediaOpParam_swiginit(self, _pjsua2.new_VideoMediaOpParam())
    __swig_destroy__ = _pjsua2.delete_VideoMediaOpParam

# Register VideoMediaOpParam in _pjsua2:
_pjsua2.VideoMediaOpParam_swigregister(VideoMediaOpParam)
class OnVideoMediaOpCompletedParam(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    opType = property(_pjsua2.OnVideoMediaOpCompletedParam_opType_get, _pjsua2.OnVideoMediaOpCompletedParam_opType_set)
    status = property(_pjsua2.OnVideoMediaOpCompletedParam_status_get, _pjsua2.OnVideoMediaOpCompletedParam_status_set)
    opParam = property(_pjsua2.OnVideoMediaOpCompletedParam_opParam_get, _pjsua2.OnVideoMediaOpCompletedParam_opParam_set)

    def __init__(self):
        _pjsua2.OnVideoMediaOpCompletedParam_swiginit(self, _pjsua2.new_OnVideoMediaOpCompletedParam())
    __swig_destroy__ = _pjsua2.delete_OnVideoMediaOpCompletedParam

# Register OnVideoMediaOpCompletedParam in _pjsua2:
_pjsua2.OnVideoMediaOpCompletedParam_swigregister(OnVideoMediaOpCompletedParam)
...
class UaConfig(PersistentObject):
    ...
    noRefersub = property(_pjsua2.UaConfig_noRefersub_get, _pjsua2.UaConfig_noRefersub_set)
...
class MediaConfig(PersistentObject):
    ...
    sndUseSwClock = property(_pjsua2.MediaConfig_sndUseSwClock_get, _pjsua2.MediaConfig_sndUseSwClock_set)
    ...
    confThreads = property(_pjsua2.MediaConfig_confThreads_get, _pjsua2.MediaConfig_confThreads_set)
...
class Endpoint(object):
    ...
    def libGetSipIoqueueHandle(self):
        return _pjsua2.Endpoint_libGetSipIoqueueHandle(self)
    ...
    def onAudioMediaOpCompleted(self, prm):
        return _pjsua2.Endpoint_onAudioMediaOpCompleted(self, prm)

    def onVideoMediaOpCompleted(self, prm):
        return _pjsua2.Endpoint_onVideoMediaOpCompleted(self, prm)
    def __disown__(self):
        self.this.disown()
